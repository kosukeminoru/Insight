...
*/
    ...
    App::new()
        ...
        .insert_resource(game::player::Attempt{first: None, second: None, third: None, fourth: None, fifth: None})
        .insert_resource(game::player::Donde{shot: 1})
        .insert_resource(game::player::MouseResource { first: Vec2::new(0.,0.), second: Vec2::new(0.,0.) })
        .insert_resource(game::player::IsReleased{b: game::player::BoolReleased::Yes}) 
