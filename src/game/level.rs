...
impl Default for Level {
    fn default() -> Level {
        Level {
            objects: vec![Object::Segment(Segment::new([-1.0*WX/2.0, -1.0*WY/2.0],[WX/2.0, -1.0*WY/2.0],"ground".to_string())),
                        Object::Rectangle(Rectangle::new(WX/4.0,-1.0*WY/2.0 + 20.0, 5.0, 20.0,"wood".to_string())),
                        Object::Rectangle(Rectangle::new(WX/4.0 + 15.0,-1.0*WY/2.0 + 45.0, 20.0, 5.0,"wood".to_string())),
                        Object::Rectangle(Rectangle::new(WX/4.0 + 30.0,-1.0*WY/2.0 + 20.0, 5.0, 20.0,"wood".to_string())),
                        Object::Circle(Circle::new(WX/4.0 + 15.0,-1.0*WY/2.0 + 5.0, 5.0,"enemy".to_string())),
                        Object::Rectangle(Rectangle::new(WX/4.0 + 41.0,-1.0*WY/2.0 + 20.0, 5.0, 20.0,"wood".to_string())),
                        Object::Rectangle(Rectangle::new(WX/4.0 + 56.0,-1.0*WY/2.0 + 45.0, 20.0, 5.0,"wood".to_string())),
                        Object::Rectangle(Rectangle::new(WX/4.0 + 71.0,-1.0*WY/2.0 + 20.0, 5.0, 20.0,"wood".to_string())),
                        Object::Circle(Circle::new(WX/4.0 + 56.0,-1.0*WY/2.0 + 5.0, 5.0,"hello".to_string()))]
        }
    }
}
