...
use subapps::default_plane::pcg::camera::dolly_free;
use subapps::default_plane::pcg::math;
use subapps::default_plane::pcg::pcg_city;
...
impl Plugin for MyApp {
    fn build(&self, app: &mut App) {
        ...
        .add_startup_system(dolly_free::setup)
        .add_system(dolly_free::update_camera)
